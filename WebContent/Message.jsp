...
<div class="col-sm-12">
  ...
  <div class="col-sm-12 col-md-10 ">
	...
	<tbody>
	  <c:forEach items="${requestScope.list}" var="resume">
      <tr height="50px">
...
${requestScope.pageBean.totalPages}</i>页，
    ...
    <ul class="paginList">
      ...
      <li class="paginItem">
		<a href="ResumeServlet?type=list&pageNo=${requestScope.pageBean.pageNo-1}">
	...
	下一页<span class="pagenxt"></span></a></li>
       ...
       <li class="paginItem">
		<a href="ResumeServlet?type=list&pageNo=${requestScope.pageBean.totalPages}">尾页</a></li>
    </ul>
  </div>
</div> --%>
	</tbody>
